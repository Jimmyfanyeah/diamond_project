...
def train_data():
    ...
    if not is_train:
        ...
        if is_finetune:
            base_model = InceptionV3(weights='imagenet', include_top =False,input_tensor=Input(shape=(imw,imw,3)))
        else:
            base_model = InceptionV3(weights=None, include_top =False,input_tensor=Input(shape=(imw,imw,3)))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cnn',            default = 'inception', help='models')
    ...
    parser.add_argument('--remark',         default='i5', help='remark for savemodel folder')
